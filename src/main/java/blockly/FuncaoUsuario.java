...
public static Var IdDoUsuarioLogado() throws Exception {
 return new Callable<Var>() {
   ...
   public Var call() throws Exception {
    lista = cronapi.database.Operations.query(Var.valueOf("app.entity.User"),Var.valueOf("select u.id from User u where u.login = :login"),Var.valueOf("login",Var.VAR_NULL));

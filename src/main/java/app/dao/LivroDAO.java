...
public interface LivroDAO extends JpaRepository<Livro, java.lang.String> {
   ...
   * @generated
   */
  @Query("SELECT entity FROM Livro entity WHERE entity.titulo like concat('%',coalesce(:search,''),'%') OR entity.autor like concat('%',coalesce(:search,''),'%')")
   ...
   * @generated
   */
  @Query("SELECT entity FROM Livro entity WHERE (:titulo is null OR entity.titulo like concat('%',:titulo,'%')) AND (:autor is null OR entity.autor like concat('%',:autor,'%')) AND (:isBN is null OR entity.isBN = :isBN)")
  public Page<Livro> specificSearch(@Param(value="titulo") java.lang.String titulo, @Param(value="autor") java.lang.String autor, @Param(value="isBN") java.lang.Double isBN, Pageable pageable);
